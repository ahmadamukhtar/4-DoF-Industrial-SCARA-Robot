...
float integral = 0.000300000004; //k_i = 3
...
void func(void)
{
	...
	if(angle>=45&&angle<=315){angle=angle-45;targetPosition =129*angle;}
}
void func(void);
