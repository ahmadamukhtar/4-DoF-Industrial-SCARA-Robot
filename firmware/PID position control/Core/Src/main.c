...
int targetPosition =2000; //the PID will try to reach this value

//-----------------------
//Measured values
int motorPosition = 0; //position based on the encoder
...
float proportional =3; //k_p = 0.5
float integral = 0.003; //k_i = 3
float derivative =130; //k_d = 1
